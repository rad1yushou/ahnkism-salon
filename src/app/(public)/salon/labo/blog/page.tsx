...
const SALON_SLUG = 'labo';
const SALON_NAME = 'LABO by AHNKISM';
const PER_PAGE = 10;
...
export default async function LaboBlogListPage({ searchParams }: Props) {
  await connection();
  ...
  const blogFirstMedia: Record<string, { media_url: string; media_type: string | null }> = {};
  if (blogs.length > 0) {

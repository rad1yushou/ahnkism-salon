...
export const metadata: Metadata = buildMetadata({
  title: 'アシスタント募集｜AHNKISM大阪',
  description: '大阪・心斎橋のAHNKISMグループのアシスタント求人。これから技術を磨きたい方を歓迎。丁寧な研修制度あり。',
  path: '/recruit/assistant',
});

export default function RecruitAssistantPage() {
  return (
    <>
      <div className="pt-20">
        <Breadcrumb
          items={[
            ...
            { name: 'アシスタント募集', path: '/recruit/assistant' },
          ]}
        />
      </div>
      <section className="py-16 sm:py-24">
        <Container narrow>
          ...
          <p className="text-sm text-stone-500 leading-relaxed mb-10">
            大阪・心斎橋のAHNKISMグループのアシスタント求人。これから技術を磨きたい方を歓迎。丁寧な研修制度あり。
          </p>

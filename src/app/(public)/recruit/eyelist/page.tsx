...
export const metadata: Metadata = buildMetadata({
  title: 'アイリスト募集｜AHNKISM大阪',
  description: '大阪・堀江のAHNKISMグループのアイリスト求人。まつ毛エクステの施術スタッフ募集。経験者・未経験者どちらも歓迎。',
  path: '/recruit/eyelist',
});

export default function RecruitEyelistPage() {
  return (
    <>
      <div className="pt-20">
        <Breadcrumb
          items={[
            ...
            { name: 'アイリスト募集', path: '/recruit/eyelist' },
          ]}
        />
      </div>
      <section className="py-16 sm:py-24">
        <Container narrow>
          ...
          <p className="text-sm text-stone-500 leading-relaxed mb-10">
            大阪・堀江のAHNKISMグループのアイリスト求人。まつ毛エクステの施術スタッフ募集。経験者・未経験者どちらも歓迎。
          </p>
